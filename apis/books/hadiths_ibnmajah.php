...
try {
    ...
    if (!$stmt) {
        jsonResponse(
            false,
            [],
            "Failed to prepare Ibn Majah hadith query",
            500
        );
    }
    ...
    jsonResponse(
        ...
        message: "Successfully retrieved Ibn Majah hadiths"
    );
    ...
    jsonResponse(
        false,
        [],
        "Failed to retrieve Ibn Majah hadiths data",
        500
    );
}
