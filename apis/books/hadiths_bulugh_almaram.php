...
try {
    ...
    if (!$stmt) {
        jsonResponse(
            false,
            [],
            "Failed to prepare Bulugh al-Maram hadith query",
            500
        );
    }
    ...
    jsonResponse(
        ...
        message: "Successfully retrieved Bulugh al-Maram hadiths"
    );
    ...
    jsonResponse(
        false,
        [],
        "Failed to retrieve Bulugh al-Maram hadiths data",
        500
    );
}
