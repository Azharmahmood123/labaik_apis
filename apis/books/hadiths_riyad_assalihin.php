...
try {
    ...
    if (!$stmt) {
        jsonResponse(
            false,
            [],
            "Failed to prepare Riyad as-Salihin hadith query",
            500
        );
    }
    ...
    jsonResponse(
        ...
        message: "Successfully retrieved Riyad as-Salihin hadiths"
    );
    ...
    jsonResponse(
        false,
        [],
        "Failed to retrieve Riyad as-Salihin hadiths data",
        500
    );
}
