...
try {
    ...
    if (!$stmt) {
        jsonResponse(
            false,
            [],
            "Failed to prepare Al-Adab al-Mufrad hadith query",
            500
        );
    }
    ...
    jsonResponse(
        ...
        message: "Successfully retrieved Al-Adab al-Mufrad hadiths"
    );
    ...
    jsonResponse(
        false,
        [],
        "Failed to retrieve Al-Adab al-Mufrad hadiths data",
        500
    );
}
